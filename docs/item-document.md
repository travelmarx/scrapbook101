...
<dl class="deflist">
    ...
    <p>
        ...
        <br/>
        <strong>Format</strong>: A JSON array of objects containing two strings and a number:
        <dl class="subdeflist">
            <dt>name</dt>
    ...
    <p>
        <strong>Default</strong>: <i>null</i>
        <br/>
        <strong>Format</strong>: A string, e.g., "year2018/jan-10" or "assets/2018/2018-12-10".
    </p>
    </dd>
    <dt>category</dt>
    ...
    <p>
        ...
        <br/>
        <strong>Format</strong>: A string, e.g. "Books".
    </p>
    </dd>
    ...
    <p>
        <strong>Default</strong>: Depends on the category chosen.
        <br/>
        <strong>Format</strong>: An object containing key-value pairs. 
    </p>
...
"categoryFields": {
    ...
    <p>
        <strong>Format</strong>: A string that is an ISO 8601 date and time, e.g., "2018-06-07T00:00:00".
    </p>
    </dd>
    <dt>dateUpdated</dt>
    ...
    <p>
        <strong>Default</strong>: Initially equal to <strong>dateAdded</strong>.
        <br/>
        <strong>Format</strong>: A string that is an ISO 8601 date and time, e.g., "2018-06-07T00:00:00".
    </p>
    </dd>
    ...
    <p>
        <strong>Default</strong>: <i>null</i>
        <br/>
        <strong>Format</strong>: A string, e.g. "The best book I've read in 2018...".
    </p>
    </dd>
    <dt>geoLocation</dt>
    ...
    <p>
        <strong>Default</strong>: <i>null</i>
        <br/>
        <strong>Format</strong>: An object that contains a string and an array:
        <dl class="subdeflist">
            <dt>type</dt>
    ...
    <strong>Required</strong>
    <br/>
    <strong>Format</strong>: A GUID, e.g., "d26f6d16-591e-4ae2-9072-d7ba113ec454".
    </p>
    </dd>
    <dt>location</dt>
    ...
    <p>
        <strong>Default</strong>: <i>null</i>
        <br/>
        <strong>Format</strong>: A string, e.g. "Seattle, WA" or "101 Main St., Seattle 98103, USA".
    </p>
    </dd>
    <dt>rating</dt>
    ...
    <p>
        <strong>Default</strong>: <i>null</i>
        <br/>
        <strong>Format</strong>: A number, e.g. 3.
    </p>
    </dd>
    <dt>title</dt>
    <dd>A descriptive title for the {{site.sn}} item. For example, if item is a book, use all or part of the book title.     <p>
        <strong>Required</strong>
        <br/>
        <strong>Format</strong>: A string, e.g. "Brief Answers to the Big Questions".
    </p>
    </dd>
    <dt>type</dt>
    ...
    <strong>Required</strong>
    <br/>
    <strong>Format</strong>: A string equal to "scrapbook101Item".
    </p>
    </dd>
    <dt>updatedBy</dt>
    ...
    <p>
        <strong>Default</strong>: <i>null</i>
        <br/>
        <strong>Format</strong>: A string, e.g. "somename@someemail.com".
    </p>
    </dd>
</dl>
